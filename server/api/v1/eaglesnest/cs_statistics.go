...
import (
	...
	response2 "github.com/EscapeBearSecond/eaglesnest/server/model/eaglesnest/response"
...
func (s *StatisticsApi) GetVulnsInfo(c *gin.Context) {
	...
	err = global.GVA_DB.Model(&eaglesnest.JobResultItem{}).
...
func (s *StatisticsApi) GetTaskInfo(c *gin.Context) {
	...
	// err = global.GVA_DB.Model(&eaglesnest.Task{}).
