...
import (
	...
	ast2 "47.103.136.241/goprojects/gin-vue-admin/server/utils/ast"

	"47.103.136.241/goprojects/gin-vue-admin/server/resource/autocode_template/subcontract"
...
func Init(Package string) {
	...
	packageInjectionMap = map[string]astInjectionMeta{
		packageServiceName: {
			...
			importCodeF:  "47.103.136.241/goprojects/gin-vue-admin/server/%s/%s",
			packageNameF: "%s",
