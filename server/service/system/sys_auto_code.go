...
import (
	...
	ast2 "codeup.aliyun.com/66d825f8c06a2fdac7bbfe8c/curescan/server/utils/ast"

	"codeup.aliyun.com/66d825f8c06a2fdac7bbfe8c/curescan/server/resource/autocode_template/subcontract"
...
func Init(Package string) {
	...
	packageInjectionMap = map[string]astInjectionMeta{
		packageServiceName: {
			...
			importCodeF:  "codeup.aliyun.com/66d825f8c06a2fdac7bbfe8c/curescan/server/%s/%s",
			packageNameF: "%s",
