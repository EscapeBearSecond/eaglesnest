...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/area", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/area/:id", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/area", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/area/:id", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/area/list", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/asset/list", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/asset/highrisk", V2: "GET"},

		{Ptype: "p", V0: "888", V1: "/template", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/template/:id", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/template", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/template/:id", V2: "DELETE"},
		...
		{Ptype: "p", V0: "888", V1: "/policy/:id", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/policy/list", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/policy/:id", V2: "GET"},

		{Ptype: "p", V0: "888", V1: "/task", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/task/:id", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/task", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/task/:id", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/task/list", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/task/execute/:id", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/task/stop/:id", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/task/report", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/task/docs", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/task/stage/:id", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/task/statistics", V2: "GET"},

		{Ptype: "p", V0: "888", V1: "/vuln/statistics", V2: "GET"},
		...
		{Ptype: "p", V0: "9528", V1: "/area", V2: "PUT"},
		{Ptype: "p", V0: "9528", V1: "/area/:id", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/area/list", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/asset/list", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/asset/highrisk", V2: "GET"},

		{Ptype: "p", V0: "9528", V1: "/template", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/template/:id", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/template", V2: "PUT"},
		{Ptype: "p", V0: "9528", V1: "/template/:id", V2: "DELETE"},
		...
		{Ptype: "p", V0: "9528", V1: "/policy/:id", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/policy/list", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/policy/:id", V2: "GET"},

		{Ptype: "p", V0: "9528", V1: "/task", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/task/:id", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/task", V2: "PUT"},
		{Ptype: "p", V0: "9528", V1: "/task/:id", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/task/list", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/task/execute/:id", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/task/stop/:id", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/task/report", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/task/docs", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/task/stage/:id", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/task/statistics", V2: "GET"},

		{Ptype: "p", V0: "9528", V1: "/vuln/statistics", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/vuln/list", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/vuln/common", V2: "GET"},
		...
		{Ptype: "p", V0: "1913", V1: "/user/admin_register", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/api/createApi", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/api/getApiList", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/api/getApiById", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/api/deleteApi", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/api/updateApi", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/api/getAllApis", V2: "POST"},

		{Ptype: "p", V0: "1913", V1: "/authority/createAuthority", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/authority/deleteAuthority", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/authority/getAuthorityList", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/authority/setDataAuthority", V2: "POST"},

		{Ptype: "p", V0: "1913", V1: "/menu/getMenu", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/menu/getMenuList", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/menu/addBaseMenu", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/menu/getBaseMenuTree", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/menu/addMenuAuthority", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/menu/getMenuAuthority", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/menu/deleteBaseMenu", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/menu/updateBaseMenu", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/menu/getBaseMenuById", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/user/changePassword", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/user/getUserList", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/user/setUserAuthority", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/fileUploadAndDownload/upload", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/fileUploadAndDownload/getFileList", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/fileUploadAndDownload/deleteFile", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/fileUploadAndDownload/editFileName", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/casbin/updateCasbin", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/casbin/getPolicyPathByAuthorityId", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/jwt/jsonInBlacklist", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/system/getSystemConfig", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/system/setSystemConfig", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/customer/customer", V2: "PUT"},
		{Ptype: "p", V0: "1913", V1: "/customer/customer", V2: "GET"},
		{Ptype: "p", V0: "1913", V1: "/customer/customer", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/customer/customer", V2: "DELETE"},
		{Ptype: "p", V0: "1913", V1: "/customer/customerList", V2: "GET"},
		{Ptype: "p", V0: "1913", V1: "/autoCode/createTemp", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/user/getUserInfo", V2: "GET"},

		{Ptype: "p", V0: "1913", V1: "/area", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/area/:id", V2: "GET"},
		{Ptype: "p", V0: "1913", V1: "/area", V2: "PUT"},
		{Ptype: "p", V0: "1913", V1: "/area/:id", V2: "DELETE"},
		{Ptype: "p", V0: "1913", V1: "/area/list", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/asset/list", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/asset/highrisk", V2: "GET"},

		{Ptype: "p", V0: "1913", V1: "/template", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/template/:id", V2: "GET"},
		{Ptype: "p", V0: "1913", V1: "/template", V2: "PUT"},
		{Ptype: "p", V0: "1913", V1: "/template/:id", V2: "DELETE"},
		{Ptype: "p", V0: "1913", V1: "/template/list", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/template/imports", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/template/tags", V2: "GET"},

		{Ptype: "p", V0: "1913", V1: "/policy", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/policy", V2: "PUT"},
		{Ptype: "p", V0: "1913", V1: "/policy/:id", V2: "DELETE"},
		{Ptype: "p", V0: "1913", V1: "/policy/list", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/policy/:id", V2: "GET"},

		{Ptype: "p", V0: "1913", V1: "/task", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/task/:id", V2: "GET"},
		{Ptype: "p", V0: "1913", V1: "/task", V2: "PUT"},
		{Ptype: "p", V0: "1913", V1: "/task/:id", V2: "DELETE"},
		{Ptype: "p", V0: "1913", V1: "/task/list", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/task/execute/:id", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/task/stop/:id", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/task/report", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/task/docs", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/task/stage/:id", V2: "GET"},
		{Ptype: "p", V0: "1913", V1: "/task/statistics", V2: "GET"},

		{Ptype: "p", V0: "1913", V1: "/vuln/statistics", V2: "GET"},
		{Ptype: "p", V0: "1913", V1: "/vuln/list", V2: "POST"},
		{Ptype: "p", V0: "1913", V1: "/vuln/common", V2: "GET"},

		{Ptype: "p", V0: "1913", V1: "/sysDictionaryDetail/findSysDictionaryDetail", V2: "GET"},
		{Ptype: "p", V0: "1913", V1: "/sysDictionary/findSysDictionary", V2: "GET"},

		{Ptype: "p", V0: "1913", V1: "/system/getServerInfo", V2: "POST"},
		...
		{Ptype: "p", V0: "1914", V1: "/api/getApiList", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/api/getApiById", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/api/deleteApi", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/api/updateApi", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/api/getAllApis", V2: "POST"},

		{Ptype: "p", V0: "1914", V1: "/authority/createAuthority", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/authority/deleteAuthority", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/authority/getAuthorityList", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/authority/setDataAuthority", V2: "POST"},

		{Ptype: "p", V0: "1914", V1: "/menu/getMenu", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/menu/getMenuList", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/menu/addBaseMenu", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/menu/getBaseMenuTree", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/menu/addMenuAuthority", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/menu/getMenuAuthority", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/menu/deleteBaseMenu", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/menu/updateBaseMenu", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/menu/getBaseMenuById", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/user/changePassword", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/user/getUserList", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/user/setUserAuthority", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/fileUploadAndDownload/upload", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/fileUploadAndDownload/getFileList", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/fileUploadAndDownload/deleteFile", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/fileUploadAndDownload/editFileName", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/casbin/updateCasbin", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/casbin/getPolicyPathByAuthorityId", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/jwt/jsonInBlacklist", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/system/getSystemConfig", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/system/setSystemConfig", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/customer/customer", V2: "PUT"},
		{Ptype: "p", V0: "1914", V1: "/customer/customer", V2: "GET"},
		{Ptype: "p", V0: "1914", V1: "/customer/customer", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/customer/customer", V2: "DELETE"},
		{Ptype: "p", V0: "1914", V1: "/customer/customerList", V2: "GET"},
		{Ptype: "p", V0: "1914", V1: "/autoCode/createTemp", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/user/getUserInfo", V2: "GET"},

		{Ptype: "p", V0: "1914", V1: "/area/:id", V2: "GET"},
		{Ptype: "p", V0: "1914", V1: "/area/list", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/asset/list", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/asset/highrisk", V2: "GET"},

		{Ptype: "p", V0: "1914", V1: "/template/:id", V2: "GET"},
		{Ptype: "p", V0: "1914", V1: "/template/list", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/template/tags", V2: "GET"},

		{Ptype: "p", V0: "1914", V1: "/policy/list", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/policy/:id", V2: "GET"},

		{Ptype: "p", V0: "1914", V1: "/task/:id", V2: "GET"},

		{Ptype: "p", V0: "1914", V1: "/task/list", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/task/report", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/task/docs", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/task/stage/:id", V2: "GET"},
		{Ptype: "p", V0: "1914", V1: "/task/statistics", V2: "GET"},

		{Ptype: "p", V0: "1914", V1: "/vuln/statistics", V2: "GET"},
		{Ptype: "p", V0: "1914", V1: "/vuln/list", V2: "POST"},
		{Ptype: "p", V0: "1914", V1: "/vuln/common", V2: "GET"},

		{Ptype: "p", V0: "1914", V1: "/sysDictionaryDetail/findSysDictionaryDetail", V2: "GET"},
		{Ptype: "p", V0: "1914", V1: "/sysDictionary/findSysDictionary", V2: "GET"},

		{Ptype: "p", V0: "1914", V1: "/system/getServerInfo", V2: "POST"},

		{Ptype: "p", V0: "1914", V1: "/sysOperationRecord/getSysOperationRecordList", V2: "GET"},
