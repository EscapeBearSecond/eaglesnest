...
import (
	"47.103.136.241/goprojects/eaglesnest/server/global"
    "47.103.136.241/goprojects/eaglesnest/server/model/{{.Package}}"
    {{.Package}}Req "47.103.136.241/goprojects/eaglesnest/server/model/{{.Package}}/request"
    "47.103.136.241/goprojects/eaglesnest/server/model/common/response"
    "47.103.136.241/goprojects/eaglesnest/server/service"
    "github.com/gin-gonic/gin"
    "go.uber.org/zap"
    {{- if .AutoCreateResource}}
    "47.103.136.241/goprojects/eaglesnest/server/utils"
    {{- end }}
)
